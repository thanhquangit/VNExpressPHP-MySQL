...
<div class="thongtin-content">
    ...
    ?>
        <ul class="ulBlockMenu">
            <li class="liFirst">
                <h2><a class="mnu_giaoduc" href=""><?php echo $row_theloai['name'] ?></a></h2>
            </li>
            <?php
            ...
            ?>
                <li class="liFollow">
                    <h2><a href="index.php?p=tintrongloai&type=<?php echo $row_loaitin['id'] ?>"><?php echo $row_loaitin['name'] ?></a></h2>
                </li>
            <?php
                }
